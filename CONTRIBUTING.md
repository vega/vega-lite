...
1. Make sure you have [node.js](https://nodejs.org/en/) installed using any method you prefer (e.g. a cross-platform node manager like [mise](https://mise.jdx.dev/lang/node.html), or an installation method specific to your OS such as [homebrew](http://brew.sh) for Mac users.
