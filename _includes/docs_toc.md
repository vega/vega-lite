...
- [Selections]({{site.baseurl}}/docs/selection.html)
    ...
    - [Single Selection Properties]({{site.baseurl}}/docs/selection.html#single)
    - [Multi Selection Properties]({{site.baseurl}}/docs/selection.html#multi)
    - [Interval Selection]({{site.baseurl}}/docs/selection.html#interval)
