...
- [Encoding]({{site.baseurl}}/docs/encoding.html)
    ...
    - [Stack]({{site.baseurl}}/docs/stack.html)
        ...
        - [Stack Bar Chart]({{site.baseurl}}/docs/stack.html#stack-bar-chart)
        - [Stack Area Chart]({{site.baseurl}}/docs/stack.html#stack-area-chart)
        - [Normalized Stacked Bar Chart]({{site.baseurl}}/docs/stack.html#normalized-stacked-bar-chart)
