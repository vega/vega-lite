 ...
 */
export declare const SINGLE_DEF_CHANNELS: ("text" | "x" | "y" | "x2" | "y2" | "color" | "opacity" | "fill" | "stroke" | "strokeWidth" | "size" | "shape" | "fillOpacity" | "strokeOpacity" | "longitude" | "latitude" | "longitude2" | "latitude2" | "key" | "href" | "url" | "facet" | "row" | "column")[];
export declare type SingleDefChannel = typeof SINGLE_DEF_CHANNELS[number];
export declare const SINGLE_DEF_UNIT_CHANNELS: ("text" | "x" | "y" | "x2" | "y2" | "color" | "opacity" | "fill" | "stroke" | "strokeWidth" | "size" | "shape" | "fillOpacity" | "strokeOpacity" | "longitude" | "latitude" | "longitude2" | "latitude2" | "key" | "href" | "url")[];
...
export declare const UNIT_CHANNELS: ("text" | "x" | "y" | "x2" | "y2" | "color" | "detail" | "opacity" | "fill" | "stroke" | "strokeWidth" | "size" | "shape" | "fillOpacity" | "strokeOpacity" | "longitude" | "latitude" | "longitude2" | "latitude2" | "key" | "tooltip" | "href" | "url" | "order")[];
export declare const NONPOSITION_CHANNELS: ("text" | "color" | "detail" | "opacity" | "fill" | "stroke" | "strokeWidth" | "size" | "shape" | "fillOpacity" | "strokeOpacity" | "key" | "tooltip" | "href" | "url" | "order")[];
...
export declare const NONPOSITION_SCALE_CHANNELS: ("color" | "opacity" | "fill" | "stroke" | "strokeWidth" | "size" | "shape" | "fillOpacity" | "strokeOpacity")[];
...
export declare const SCALE_CHANNELS: ("x" | "y" | "color" | "opacity" | "fill" | "stroke" | "strokeWidth" | "size" | "shape" | "fillOpacity" | "strokeOpacity")[];
