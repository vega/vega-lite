...
export declare function values(specifiedAxis: Axis, model: UnitModel, fieldDef: FieldDef<string>, channel: PositionScaleChannel): (string | number | boolean | import("../../../../../../../../Users/domoritz/Developer/UW/vega-lite-2/src/datetime").DateTime | {
    signal: string;
})[] | {
    signal: string;
};
