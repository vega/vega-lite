...
export declare function minMaxExtent(isGridAxis: boolean, scaleType: ScaleType, axisConfig: AxisConfig): number;
export declare function orient(channel: Channel): "left" | "bottom";
export declare function tickCount(channel: Channel, fieldDef: FieldDef<string>): number;
