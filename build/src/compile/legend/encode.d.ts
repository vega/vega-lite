...
import { FieldDefWithCondition, Gradient, MarkPropFieldDef, TypedFieldDef, Value, ValueDefWithCondition } from '../../channeldef';
...
export declare function getFirstConditionValue<V extends Value | Gradient>(channelDef: FieldDefWithCondition<MarkPropFieldDef<string>, V> | ValueDefWithCondition<MarkPropFieldDef<string>, V>): V;
