...
export declare function getDefaultValue(property: keyof Scale, channel: Channel, fieldDef: FieldDef<string>, sort: SortOrder | SortField<string> | string[], scaleType: ScaleType, scalePadding: number, scalePaddingInner: number, specifiedDomain: Scale['domain'], markDef: MarkDef, config: Config): any;
...
export declare function reverse(scaleType: ScaleType, sort: SortOrder | SortField<string> | string[]): boolean;
