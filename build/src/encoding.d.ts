...
import { ChannelDef, ColorGradientFieldDefWithCondition, ColorGradientValueDefWithCondition, Field, FieldDef, FieldDefWithoutScale, LatLongFieldDef, NumericFieldDefWithCondition, NumericValueDefWithCondition, OrderFieldDef, PositionFieldDef, SecondaryFieldDef, ShapeFieldDefWithCondition, ShapeValueDefWithCondition, TextFieldDef, TextFieldDefWithCondition, TextValueDefWithCondition, TypedFieldDef, ValueDef } from './channeldef';
...
export declare function normalizeEncoding(encoding: Encoding<string>, markDef: MarkDef): Encoding<string>;
