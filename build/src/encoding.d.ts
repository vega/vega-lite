import { FieldDef, PositionFieldDef, LegendFieldDef, OrderFieldDef, ValueDef, TextFieldDef, ConditionalValueDef } from './fielddef';
...
export declare function dropInvalidFieldDefs(mark: Mark, encoding: Encoding): Encoding;
