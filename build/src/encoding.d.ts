...
import { Conditional, Field, FieldDef, LegendFieldDef, OrderFieldDef, PositionFieldDef, TextFieldDef, ValueDef } from './fielddef';
...
export interface Encoding<F> {
     ...
     */
    shape?: Conditional<LegendFieldDef<F>, ValueDef<string>>;
    /**
