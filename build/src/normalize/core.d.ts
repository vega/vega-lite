...
export declare class CoreNormalizer extends SpecMapper<NormalizerParams, FacetedUnitSpec, ExtendedLayerSpec> {
    ...
    map(spec: GenericSpec<FacetedUnitSpec, ExtendedLayerSpec>, params: NormalizerParams): GenericSpec<import("../spec").GenericUnitSpec<Encoding<Field>, "area" | "bar" | "line" | "image" | "trail" | "point" | "text" | "tick" | "rect" | "rule" | "circle" | "square" | "geoshape" | import("../mark").MarkDef<import("../mark").Mark>>, GenericLayerSpec<import("../spec").GenericUnitSpec<Encoding<Field>, "area" | "bar" | "line" | "image" | "trail" | "point" | "text" | "tick" | "rect" | "rule" | "circle" | "square" | "geoshape" | import("../mark").MarkDef<import("../mark").Mark>>>>;
