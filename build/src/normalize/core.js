    ...
    getFacetMappingAndLayout(facets) {
        ...
        if (row || column) {
            ...
            for (const channel of [ROW, COLUMN]) {
                ...
                if (def) {
                    const { align, center, spacing, columns } = def, defWithoutLayout = tslib_1.__rest(def, ["align", "center", "spacing", "columns"]);
            ...
            const { align, center, spacing, columns } = facet, facetMapping = tslib_1.__rest(facet, ["align", "center", "spacing", "columns"]);
            return {
                facetMapping,
