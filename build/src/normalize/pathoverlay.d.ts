...
export declare class PathOverlayNormalizer implements NonFacetUnitNormalizer<UnitSpecWithPathOverlay> {
    ...
    run(spec: UnitSpecWithPathOverlay, params: NormalizerParams, normalize: NormalizeLayerOrUnit): GenericUnitSpec<Encoding<Field>, "area" | "bar" | "line" | "image" | "trail" | "point" | "text" | "tick" | "rect" | "rule" | "circle" | "square" | "geoshape" | MarkDef<Mark>> | import("../spec").GenericLayerSpec<GenericUnitSpec<Encoding<Field>, "area" | "bar" | "line" | "image" | "trail" | "point" | "text" | "tick" | "rect" | "rule" | "circle" | "square" | "geoshape" | MarkDef<Mark>>>;
}
export {};
