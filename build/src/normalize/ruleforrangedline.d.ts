...
export declare class RuleForRangedLineNormalizer implements NonFacetUnitNormalizer<RangedLineSpec> {
    ...
    run(spec: RangedLineSpec, params: NormalizerParams, normalize: NormalizeLayerOrUnit): GenericUnitSpec<Encoding<Field>, "circle" | "square" | "area" | "image" | "line" | "rect" | "rule" | "text" | "trail" | "point" | "geoshape" | "bar" | "tick" | import("../mark").MarkDef<import("../mark").Mark>> | import("../spec").GenericLayerSpec<GenericUnitSpec<Encoding<Field>, "circle" | "square" | "area" | "image" | "line" | "rect" | "rule" | "text" | "trail" | "point" | "geoshape" | "bar" | "tick" | import("../mark").MarkDef<import("../mark").Mark>>>;
}
export {};
