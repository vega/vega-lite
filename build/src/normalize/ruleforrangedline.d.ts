...
export declare class RuleForRangedLineNormalizer implements NonFacetUnitNormalizer<RangedLineSpec> {
    ...
    run(spec: RangedLineSpec, params: NormalizerParams, normalize: NormalizeLayerOrUnit): GenericUnitSpec<Encoding<Field>, "area" | "bar" | "line" | "image" | "trail" | "point" | "text" | "tick" | "rect" | "rule" | "circle" | "square" | "geoshape" | import("../mark").MarkDef<import("../mark").Mark>> | import("../spec").GenericLayerSpec<GenericUnitSpec<Encoding<Field>, "area" | "bar" | "line" | "image" | "trail" | "point" | "text" | "tick" | "rect" | "rule" | "circle" | "square" | "geoshape" | import("../mark").MarkDef<import("../mark").Mark>>>;
}
export {};
