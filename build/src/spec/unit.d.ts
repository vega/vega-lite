 ...
 */
export declare type CompositeUnitSpec = GenericUnitSpec<CompositeEncoding, AnyMark>;
/**
 * Unit spec that can have a composite mark and row or column channels (shorthand for a facet spec).
 */
export declare type FacetedCompositeUnitSpec = GenericUnitSpec<FacetedCompositeEncoding, AnyMark>;
export declare type TopLevelUnitSpec = TopLevel<FacetedCompositeUnitSpec> & DataMixins;
