...
export declare type Transform = AggregateTransform | BinTransform | CalculateTransform | FilterTransform | FlattenTransform | FoldTransform | ImputeTransform | JoinAggregateTransform | LookupTransform | TimeUnitTransform | SampleTransform | StackTransform | WindowTransform;
export declare function normalizeTransform(transform: Transform[]): (AggregateTransform | BinTransform | CalculateTransform | FlattenTransform | FoldTransform | ImputeTransform | JoinAggregateTransform | LookupTransform | TimeUnitTransform | SampleTransform | StackTransform | WindowTransform | {
    filter: LogicalOperand<Predicate>;
})[];
