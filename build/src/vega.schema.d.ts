...
export declare type VgTransform = VgBinTransform | VgExtentTransform | VgFormulaTransform | VgAggregateTransform | VgFilterTransform | VgFlattenTransform | VgImputeTransform | VgStackTransform | VgCollectTransform | VgLookupTransform | VgIdentifierTransform | VgGeoPointTransform | VgGeoJSONTransform | VgWindowTransform | VgJoinAggregateTransform | VgFoldTransform | VgSampleTransform;
...
export declare const VG_MARK_CONFIGS: ("dir" | "font" | "cursor" | "text" | "stroke" | "shape" | "interpolate" | "fill" | "opacity" | "fillOpacity" | "strokeOpacity" | "strokeWidth" | "size" | "tooltip" | "href" | "strokeDash" | "strokeDashOffset" | "strokeJoin" | "strokeMiterLimit" | "strokeCap" | "orient" | "tension" | "align" | "angle" | "baseline" | "dx" | "dy" | "radius" | "limit" | "ellipsis" | "theta" | "fontSize" | "fontStyle" | "fontWeight" | "cornerRadius")[];
