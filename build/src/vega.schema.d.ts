...
export declare type VgTransform = VgBinTransform | VgExtentTransform | VgFormulaTransform | VgAggregateTransform | VgFilterTransform | VgImputeTransform | VgStackTransform | VgCollectTransform | VgLookupTransform | VgIdentifierTransform | VgGeoPointTransform | VgGeoJSONTransform | VgGeoJSONTransform;
...
export declare const VG_MARK_CONFIGS: ("font" | "text" | "shape" | "fill" | "stroke" | "opacity" | "size" | "href" | "interpolate" | "strokeWidth" | "strokeDash" | "strokeDashOffset" | "strokeOpacity" | "fillOpacity" | "orient" | "tension" | "align" | "angle" | "baseline" | "dx" | "dy" | "radius" | "limit" | "theta" | "fontSize" | "fontStyle" | "fontWeight" | "cursor")[];
