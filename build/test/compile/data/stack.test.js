...
describe('compile/data/stack', () => {
    ...
    describe('StackNode.producedFields', () => {
        ...
        it('should generate the correct hash', () => {
            ...
            const stack = StackNode.makeFromEncoding(null, model);
            expect(stack.hash()).toEqual('Stack {"as":["sum_a_start","sum_a_end"],"dimensionFieldDef":{"field":"b","type":"nominal"},"facetby":[],"impute":false,"offset":"zero","sort":{"field":["c"],"order":["descending"]},"stackField":"sum_a","stackby":["c"]}');
        });
