...
describe('Interval Selections', () => {
    ...
    describe('Tuple Signals', () => {
        it('builds projection signals', () => {
            ...
            expect(oneSg).toEqual(expect.arrayContaining([
                {
                    name: 'one_x',
                    value: [],
                    on: [
            ...
            expect(threeSg).toEqual(expect.arrayContaining([
                {
                    name: 'thr_ee_x',
                    value: [],
                    on: [
            ...
            expect(fourSg).toEqual(expect.arrayContaining([
                {
                    name: 'four_x',
                ...
                },
                {
                    ...
                    update: '(!isArray(four_Horsepower) || (+invert("x", four_x)[0] === +four_Horsepower[0] && +invert("x", four_x)[1] === +four_Horsepower[1])) ? four_scale_trigger : {}'
                }
            ]));
            const fiveSg = interval.signals(model, selCmpts['five']);
            expect(fiveSg).toEqual(expect.arrayContaining([
                {
                    name: 'five_x',
                ...
                },
                {
                    ...
                    update: '(!isArray(five_Horsepower) || (+invert("x", five_x)[0] === +five_Horsepower[0] && +invert("x", five_x)[1] === +five_Horsepower[1])) && (!isArray(five_Miles_per_Gallon) || (+invert("y", five_y)[0] === +five_Miles_per_Gallon[0] && +invert("y", five_y)[1] === +five_Miles_per_Gallon[1])) ? five_scale_trigger : {}'
                }
            ]));
            const sixSg = interval.signals(model, selCmpts['six']);
            expect(sixSg).toEqual(expect.arrayContaining([
                {
                    name: 'six_x',
                ...
                },
                {
                    ...
                    update: '(!isArray(six_Horsepower) || (+invert("x", six_x)[0] === +six_Horsepower[0] && +invert("x", six_x)[1] === +six_Horsepower[1])) ? six_scale_trigger : {}'
                }
            ]));
        });
                ...
                on: [
                    {
                        ...
                        update: 'five_Horsepower && five_Miles_per_Gallon ? {unit: "", fields: five_tuple_fields, values: [five_Horsepower,five_Miles_per_Gallon]} : null'
                    }
                ]
            });
        });
