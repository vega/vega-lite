...
function voronoiMark(x, y, tooltipEncode = {}) {
    return [
        { hello: 'world' },
        {
            name: 'voronoi',
            ...
            from: { data: 'marks' },
            encode: {
                update: Object.assign({ fill: { value: 'transparent' }, strokeWidth: { value: 0.35 }, stroke: { value: 'transparent' }, isVoronoi: { value: true } }, tooltipEncode)
            },
            transform: [
                {
                    type: 'voronoi',
