...
do
  ...
  then
    ...
    npx vg2svg --seed 123456789 examples/compiled/$name.vg.json > examples/compiled/$name.svg
    npx vg2png --seed 123456789 examples/compiled/$name.vg.json > examples/compiled/$name.png
  fi
done
