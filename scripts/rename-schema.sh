...
perl -pi -e s,'Conditional<TextFieldDef>','ConditionalTextDef',g build/vega-lite-schema.json
...
perl -pi -e s,'Conditional<LegendFieldDef\>','ConditionalLegendDef',g build/vega-lite-schema.json
