...
permalink: /docs/selection-nearest.html
---
...
The `nearest` transform also respects any [spatial encoding projections](selection-project.html) applied to the selection. For instance, in the example below, moving the mouse cursor back-and-forth snaps the vertical rule and label to the nearest `date` value.
