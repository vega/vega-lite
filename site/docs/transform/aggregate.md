...
Sometimes, you may not want to find the minimum or maximum of a field but the value from a field corresponds to the minimum or maximum value in another fields. In these cases you can use the argmin and argmax aggregates.
