...
- [Liminoid](https://liminoid.io/), toolkit for building interactive analytics applications with Python and WebAssembly. Can pass Python data to Javascript callbacks which render Vega/Vega-Lite [specifications](https://vega.github.io/vega/docs/specification/).  
