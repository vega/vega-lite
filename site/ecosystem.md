...
- [StatisticalGraphics.jl](https://github.com/sl-solution/StatisticalGraphics.jl), a Julia library for producing statistical graphics. It exploits Julia to enhance Vega for data analysis.  
