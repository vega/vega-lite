var examples = [
  {name: 'bar',              editor: true, row: 0, col: 0, x: [83, 36, 97],    y: [0, -18, 9],   width: 210, height: 200},
  {name: 'grouped_bar',      editor: true, row: 0, col: 1, x: [10, 10, 175],   y: [-148, -210, 0], width: 259, height: 150},
