...
First, you need a chart. You can start with the [examples from the Vega-Lite website]({{ site.baseurl}}/examples/), an [Altair](https://altair-viz.github.io/) chart, or a chart on [Observable](https://beta.observablehq.com/@domoritz/hello-vega-embed). Then open the Vega-Lite chart in the [Vega-Lite editor](https://vega.github.io/editor/).
...
<img src="{{ site.baseurl }}/site/static/falcon.png" style="max-width: 500px">
...
<video controls style="max-width: 700px">
  <source src="{{ site.baseurl }}/site/static/share.mp4" type="video/mp4">
</video>

## Print to PDF

Unfortunately, Latex cannot import SVGs so we will have to convert it to PDF. There are many ways to do this: using illustrator, other image editor, command line scripts, or printing as PDF in the browser. You are free to use any of these tools if they fit your workflow but for this tutorial we are going to use the printing feature of your browser. To do this, select "File" and then "Print..." (or use <kbd>Cmd</kbd>+<kbd>P</kbd>) in your Chrome or Firefox browser.
