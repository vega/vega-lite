...
export const UNIT_CHANNELS = [X, Y, X2, Y2, SIZE, SHAPE, COLOR, ORDER, OPACITY, TEXT, DETAIL, LABEL];  // CHANNELS without COLUMN, ROW
export const UNIT_SCALE_CHANNELS = [X, Y, SIZE, SHAPE, COLOR, OPACITY]; // UNIT_CHANNELS without X2, Y2, ORDER, DETAIL, TEXT, LABEL
export const SCALE_CHANNELS = [X, Y, SIZE, SHAPE, COLOR, OPACITY, ROW, COLUMN];  // UNIT_SCALE_CHANNELS with ROW, COLUMN
export const NONSPATIAL_CHANNELS = [SIZE, SHAPE, COLOR, ORDER, OPACITY, TEXT, DETAIL, LABEL]; // UNIT_CHANNELS without X, Y, X2, Y2;
