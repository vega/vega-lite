...
import {isAggregateOp, isArgmaxDef, isArgminDef, isCountingAggregateOp} from './aggregate.js';
import {autoMaxBins, binToString, isBinned, isBinning} from './bin.js';
import {
  ANGLE,
  COLOR,
  COLUMN,
...
import {hasDiscreteDomain, isContinuousToDiscrete, SCALE_CATEGORY_INDEX} from './scale.js';
import {isSortByChannel} from './sort.js';
...
import {getFullName, QUANTITATIVE} from './type.js';
import {
  flatAccessWithDatum,
  getFirstDefined,
  hasProperty,
