...
export class StackNode extends DataFlowNode {
  ...
  public static make(model: UnitModel) {
    ...
    if (orderDef) {
      ...
      sort = stackby.reduce((s, fieldName) => {
        s.field.push(fieldName);
  ...
  public dependentFields() {
    ...
    const fieldName = this._stack.sort.field;
    isArray(fieldName) ? fieldName.forEach(f => out[f] = true) : out[fieldName] = true;
