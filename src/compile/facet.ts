...
export class FacetModel extends ModelWithField {
  ...
  private initFacet(
    ...
    if (!isFacetMapping(facet)) {
      return {facet: this.initFacetFieldDef(facet, 'facet', config)};
    }
    ...
    for (const channel of channels) {
      ...
      normalizedFacet[channel] = this.initFacetFieldDef(fieldDef, channel, config);
    }
  ...
  private initFacetFieldDef(
    fieldDef: FacetFieldDef<FieldName, ExprOrSignalRef>,
