...
import {getSecondaryRangeChannel, isScaleChannel, isXorY} from '../../channel.js';
import {
  binRequiresRange,
  getBandPosition,
  getFieldOrDatumDef,
...
import {hasDiscreteDomain, isDomainUnionWith, isParameterDomain} from '../../scale.js';
import {DEFAULT_SORT_OP, isSortArray, isSortByEncoding, isSortField} from '../../sort.js';
import {normalizeTimeUnit} from '../../timeunit.js';
import * as util from '../../util.js';
import {isDataRefDomain, isDataRefUnionedDomain, isFieldRefUnionDomain, isSignalRef} from '../../vega.schema.js';
...
import {makeExplicit, makeImplicit, mergeValuesWithExplicit} from '../split.js';
