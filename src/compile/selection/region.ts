...
import {SelectionCompiler, STORE, TUPLE, unitName} from './index.js';
...
const region: SelectionCompiler<'region'> = {
  ...
  parse: (model, selCmpt, selDef) => {
    ...
    selDef.select = {type: 'region', fields: [SELECTION_ID]};
  },
  ...
  marks: (model, selCmpt, marks) => {
    ...
    // This check should be unpassable for regions since scales.defined() requires selCmpt.type === 'interval' , which is never true for regions.
