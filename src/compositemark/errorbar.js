import {isContinuousFieldOrDatumDef, isFieldOrDatumDef, title} from '../channeldef.js';
import {extractTransformsFromEncoding, normalizeEncoding} from '../encoding.js';
...
export function errorBarParams(spec, compositeMark, config) {
  ...
  const tooltipEncoding = getCompositeMarkTooltip(
    tooltipSummary,
    continuousAxisChannelDef,
    encodingWithoutContinuousAxis,
