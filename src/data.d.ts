...
export declare type Data = UrlData | InlineData | InternalData;
...
export declare function isUrlData(data: Data): data is UrlData;
export declare function isInlineData(data: Data): data is InlineData;
export declare function isInternalData(data: Data): data is InternalData;
export declare type DataSourceType = 'source' | 'summary' | 'stacked' | 'layout';
export declare const SUMMARY: 'summary';
export declare const SOURCE: 'source';
export declare const STACKED: 'stacked';
