...
export type GuideEncodingConditonalValueDef = ValueDef & ConditionValueDefMixins;

export type GuideEncodingEntry = Partial<Record<VgEncodeChannel, GuideEncodingConditonalValueDef | SignalRef>>;
