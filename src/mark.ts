...
export interface MarkConfig extends ColorMixins, BaseMarkConfig {
  ...
  /**
   * Default band for a time unit.
   */
  timeUnitBand?: 0 | 0.5 | 1;
}
...
export interface RectConfig extends RectBinSpacingMixins, MarkConfig {
  ...
  /**
   * The default size of the bars with discrete dimensions.  If unspecified, the default size is  `step-2`,
   * which provides 2 pixel offset between bars.
   * @minimum 0
   */
