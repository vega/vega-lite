...
export interface LayoutSizeMixins {
   ...
   * - If no field is mapped to `x` channel, the `width` will be the value of [`config.scale.rangeStep`](https://vega.github.io/vega-lite/docs/size.html#default-width-and-height).
   *
