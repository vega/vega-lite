...
import {BaseSpec, DataMixins, LayerUnitMixins, ResolveMixins} from './base';
 ...
 */
export type FacetedUnitSpec = GenericUnitSpec<FacetedCompositeEncoding, AnyMark> & ResolveMixins;
