...
export declare const STACKABLE_MARKS: ("area" | "circle" | "line" | "text" | "bar" | "point" | "rule" | "tick" | "square")[];
export declare const STACK_BY_DEFAULT_MARKS: ("area" | "bar")[];
export declare function stack(mark: Mark, encoding: Encoding, stacked: StackOffset): StackProperties;
