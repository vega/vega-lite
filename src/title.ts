...
import {ReplaceValueRefWithSignalRef, ExcludeValueRef} from './vega.schema';

export type BaseTitleNoValueRefs = ReplaceValueRefWithSignalRef<Omit<BaseTitle, 'align' | 'baseline'>> &
  // Since some logic depends on align/baseline, Vega-Lite does NOT allow signal for them.
  ExcludeValueRef<Pick<BaseTitle, 'align' | 'baseline'>>;
