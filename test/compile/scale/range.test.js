    ...
    describe('rangeMixins()', function () {
        ...
        describe('opacity', function () {
            it('should use default opacityRange as opacity\'s scale range.', function () {
                chai_1.assert.deepEqual(range_1.default('opacity', 'linear', type_1.QUANTITATIVE, {}, config_1.defaultConfig, undefined, 'point', undefined, []), { range: [mark.defaultMarkConfig.minOpacity, mark.defaultMarkConfig.maxOpacity] });
            });
        });
        describe('size', function () {
            ...
            describe('tick', function () {
                ...
                it('should return [(default)minBandSize, rangeStep-1] by default since maxSize config is not specified', function () {
                    chai_1.assert.deepEqual(range_1.default('size', 'linear', type_1.QUANTITATIVE, {}, config_1.defaultConfig, undefined, 'tick', undefined, []), { range: [config_1.defaultConfig.tick.minBandSize, config_1.defaultConfig.scale.rangeStep - 1] });
                });
            });
            describe('text', function () {
                it('should return [minFontSize, maxFontSize]', function () {
                    chai_1.assert.deepEqual(range_1.default('size', 'linear', type_1.QUANTITATIVE, {}, config_1.defaultConfig, undefined, 'text', undefined, []), { range: [config_1.defaultConfig.text.minFontSize, config_1.defaultConfig.text.maxFontSize] });
                });
            });
            describe('rule', function () {
                it('should return [minStrokeWidth, maxStrokeWidth]', function () {
                    chai_1.assert.deepEqual(range_1.default('size', 'linear', type_1.QUANTITATIVE, {}, config_1.defaultConfig, undefined, 'rule', undefined, []), { range: [config_1.defaultConfig.rule.minStrokeWidth, config_1.defaultConfig.rule.maxStrokeWidth] });
                });
            });
